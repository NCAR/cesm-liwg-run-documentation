...
set test_casename  = b.e13.BG1850C5L45.f19_g16.CAMForcingAtMeanHeight.001
set test_filetype = monthly_history 
#set test_filetype = time_series

set test_path_history =  /glade/p/cesm/liwg_dev/sacks/archive/$test_casename/atm/hist/
set test_path_climo   =  /glade/p/cesm/liwg_dev/sacks/CAM_CLM_topography_differences_amwg/climo/$test_casename/
set test_path_diag    =  /glade/p/cesm/liwg_dev/sacks/CAM_CLM_topography_differences_amwg/diag/$test_casename/
set test_path_HPSS    =  NA
...
set cntl_casename   =  b.e13.BG1850C5L45.f19_g16.AllToposEqualCAM.001
set cntl_filetype = monthly_history 
#set cntl_filetype = time_series

set cntl_path_history = /glade/p/cesm/liwg_dev/sacks/archive/$cntl_casename/atm/hist/
set cntl_path_climo   = /glade/p/cesm/liwg_dev/sacks/CAM_CLM_topography_differences_amwg/climo/$cntl_casename/
set cntl_path_HPSS    = NA
...
set test_first_yr = 26           # first year (must be >= 1)
set test_nyrs     = 25           # number of yrs (must be >= 1)

# FOR CNTL == USER ONLY (otherwise skip this section)
# First year of data is: $cntl_first_yr     (must be >= 1)
# Number of years is: $cntl_nyrs         (must be >= 1)

set cntl_first_yr = 26        # first year (must be >= 1)
set cntl_nyrs     = 25        # number of yrs (must be >= 1)
...
set test_name = CAMForcingAtMeanHeight               # test case name 
set cntl_name = AllToposEqualCAM              # control case name
...
set email_address = sacks@ucar.edu
